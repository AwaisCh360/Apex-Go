...
// It is set by main from the APEX_VERSION env var (see go_tui.py), matching
// Python's get_package_version() which reads the installed "apex-agent" version
...
const (
	...
	setupPlaceholderShort = "What should Apex test?"
...
// splashTick drives the splash "Starting Apex Agent" shimmer at Python's 0.1s cadence.
